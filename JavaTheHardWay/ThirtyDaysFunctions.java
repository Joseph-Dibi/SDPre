...
/**
 *Contains functinos that make it easier to work with momths
 */
 ...
 * @Returns     the English name of the month, or "error" if out of Rectangle
 */
 ...
 public static String monthName( int month )
 {
   ...
   * @author Joseph DiBiasi
   * @param month the month number (1-12)
   * @Returns   the number of days in the monthDays
   */
